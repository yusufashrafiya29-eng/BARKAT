...
# Mimic the payload sent by the frontend
payload = {
    "table_id": "10618532-19bd-4e20-8c52-5801b6d36a16", # Valid table ID from db
    "items": [
        {
            "menu_item_id": "edcf22db-ea40-42f5-8153-2c3dbeff81db", # Valid menu item
            "quantity": 1,
            "is_parcel": False
        }
    ],
