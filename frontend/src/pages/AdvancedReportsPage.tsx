...
const REPORT_TYPES = [
  ...
  { id: 'captain', label: 'Captain Wise Summary' },
...
export default function AdvancedReportsPage() {
  ...
  const handleExportExcel = () => {
    ...
    csvContent += columns.map(formatHeader).join(",") + "\n";
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin py-2">
          {REPORT_TYPES.map(rt => (
            <button
              ...
              className={`w-full text-left px-4 py-2.5 text-[13px] font-medium transition-all border-l-2 ${
                activeReport === rt.id 
