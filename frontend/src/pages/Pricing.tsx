...
const PLANS = [
  {
    ...
    highlight: false,
    badge: null,
    limits: '10 Tables • 2 Staff Accounts',
  },
  {
    id: 'pro',
    name: 'Pro',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes! Yearly plans include 2 months free — saving you ₹1,600 on Basic, ₹2,800 on Pro, and ₹3,998 on Max compared to monthly billing.',
  },
  {
